...
# Config plot for DSRCT neotranscripts.
...
# Generic parameters
output_folder=/data/kdi_prod/project_result/726/27.03/results/tests/
if [ ! -d $output_folder ] ; then mkdir $output_folder ; fi
input_folder=/data/kdi_prod/project_result/726/27.03/results/1_Data/
...
gtf_name=200624_DSRCT_neos_NEW_IDs
